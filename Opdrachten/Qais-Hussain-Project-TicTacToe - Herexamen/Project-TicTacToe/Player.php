...
<html>
  ...
  <?php 
	  ...
	  try {
        ...
        $pdoConnect = new PDO("mysql:host=localhost;dbname=id5753310_scoretictactoe", "id5753310_tictactoe", "143QAIS54726q");
          ...
          <div data-page="index" class="page">
           ...
           <!-- <div class="content-block-title">Tic Tac Toe</div>-->
              ...
              <div id="playersinvoer">
				...
				<div class="toolbar-inner"> <a href="#" class="button" onclick="herstartenfunctie()">Herstarten</a> <a href="#" id ="BtnPlay" class="button" onclick="pauseFunction()">Muziek Uit/Aan</a> <a href="#" data-panel="right" onclick="runMyFunction()" class="button open-panel">Scoreboard</a> </div>
