          ...
          <div data-page="index" class="page">
           ...
           <!-- <div class="content-block-title">Tic Tac Toe</div>-->
              ...
              <div id="playersinvoer">
				...
				<div class="toolbar-inner"> <a href="#" class="button" onclick="herstartenfunctie()">Herstarten</a> <a href="#" id ="BtnPlay" class="button" onclick="pauseFunction()">Muziek Uit/Aan</a> <a href="#" data-panel="right" class="button open-panel">Scoreboard</a> </div>
